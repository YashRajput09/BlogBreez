  ...
  return (
    <div className="flex min-h-screen w-screen items-center justify-center text-gray-600 bg-gray-50 relative">
      <div className="relative">
        ...
        <div className="hidden sm:block h-28 w-28 text-indigo-300 absolute z-0 -right-20 -bottom-20">
          <svg
            id="patternId"
            width="100%"
            height="100%"
        ...
        {/* Login Form */}
        <div className="relative z-10 flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
